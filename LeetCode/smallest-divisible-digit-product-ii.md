...
**Problem link:** [View on LeetCode](https://leetcode.com/problems/smallest-divisible-digit-product-ii/) &nbsp;|&nbsp; **Solved:** 2026-08-07

---

## 📝 Summary

Find the smallest number greater than or equal to `num` whose digit product is divisible by `t`.

## 🔍 Key Observation

Since digits only contain prime factors 2, 3, 5, and 7, `t` can only have these prime factors. We can precompute via DP the minimum number of digits needed to satisfy remaining powers of 2 and 3, then use this for fast feasibility checks during greedy digit construction.

## ⚙️ Algorithm

**Dynamic Programming + Greedy Digit Construction**
...
`dynamic-programming` `greedy` `string` `math` `number-theory`
